...
- Scroll-scrubbed architectural and motorsport films with exact forward, pause, and reverse control
...
- Lightweight 2.5D depth built from film, typography, grading, and layered interface motion
...
The main branch deploys the static GitHub Pages build automatically. The Pages entrypoint reuses the same React experience, styles, imagery, fonts, scroll-controlled video, and privacy-preserving inquiry flow as the primary application.

The three homepage examples open full industry concept pages for motorsport, construction, and medical organizations. Each route can be previewed at Essential, Premium, or Ultimate quality through a shareable `?tier=` parameter. APEX uses the supplied racing film as a scroll-controlled visual surface; the other concepts retain their responsive editorial imagery.
