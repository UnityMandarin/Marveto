...
export const projects: Project[] = [
  {
    ...
    index: '01',
    title: 'APEX',
    sector: 'Motorsport · Studio concept',
    statement: 'Velocity becomes a brand you can feel before the ignition.',
    summary:
      'A cinematic race-car website concept that turns speed, engineering, and precision into a scroll-controlled digital experience.',
    deliverables: ['Race storytelling', 'Performance data', 'Cinematic motion', 'Inquiry journey'],
    image: '/videos/race-car.mp4',
    alt: 'A race car accelerating through a cinematic environment.',
    accent: '#ff3d18',
    surface: '#0a0a0a',
  },
  {
    ...
    statement: 'The stay begins before arrival.',
    summary:
      'A cinematic hotel website concept that turns room discovery, atmosphere, and booking into one seamless scroll-controlled journey.',
    deliverables: ['Suite discovery', 'Destination storytelling', 'Immersive motion', 'Booking journey'],
    image: '/videos/hotel-walkthrough.mp4',
    alt: 'A cinematic walkthrough of a warm, refined hotel suite.',
    accent: '#d7b37a',
    surface: '#17120e',
  },
  {
    ...
    statement: 'Built with purpose. Made to endure.',
    summary:
      'A cinematic construction website that reveals the craft, scale, and precision behind every project.',
    deliverables: ['Project portfolio', 'Construction expertise', 'Cinematic motion', 'Project inquiry'],
    image: '/videos/construction-film.mp4',
    alt: 'A cinematic construction film showing spaces taking shape.',
    accent: '#b7a7ff',
    surface: '#202938',
  },
];
...
export const pricingTiers: PricingTier[] = [
  ...
  },
  {
    ...
    displayPrice: '$1,799',
    badge: 'Max result',
    positioning: 'For businesses that need a high-detail visual environment with scroll-controlled film and adaptive cinematic pacing.',
    features: [
      'Everything included in Premium',
      'Art-directed film integration',
      'Scroll-controlled 2.5D depth',
      'Adaptive cinematic pacing',
      'Domain connection and launch',
